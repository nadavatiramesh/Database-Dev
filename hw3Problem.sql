HW3: Due Feb 17, midnight
For each question, I list the problem and the expected answers (remember that the order of rows and columns might be different in some cases).
...
Qn 10. Find the products (ProductKey and ProductName) that were sold both in United States (SalesTerritoryCountry = 'United States') but not in Canada (SalesTerritoryCountry = 'Canada')
